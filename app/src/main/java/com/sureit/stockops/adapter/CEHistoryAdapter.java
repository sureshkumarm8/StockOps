...
public class CEHistoryAdapter extends RecyclerView.Adapter<CEHistoryAdapter.ViewHolder> {

    private List<BankNiftyList> bankNiftyLists;
    private Context context;

    public CEHistoryAdapter(List<BankNiftyList> bankNiftyLists, Context context){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new CEHistoryAdapter.ViewHolder(v);
    }
